...
export const patientDataFields: Fields<PatientData> = {
    ...
    skin: {
        ...
        initial: "",
        type: "editableSelect",
        options: PATIENT_DATA_OPTIONS.skin,
    },
    heartSounds: {
        min: 2,
        max: 100,
        ...
        initial: "",
        type: "editableSelect",
        options: PATIENT_DATA_OPTIONS.heartSounds,
    },
    pulse: {
        min: 2,
        max: 100,
    ...
    stomach: {
        ...
        initial: "",
        type: "editableSelect",
        options: PATIENT_DATA_OPTIONS.stomach,
    },
    liver: {
        min: 2,
        max: 100,
        ...
        initial: "",
        type: "editableSelect",
        options: PATIENT_DATA_OPTIONS.liver,
    },
    pasternackiSymptom: {
        min: 2,
        max: 100,
        ...
        initial: "",
        type: "editableSelect",
        options: PATIENT_DATA_OPTIONS.pasternackiSymptom,
    },
    chair: {
        min: 2,
        max: 100,
    ...
    axillaryL_v: {
        ...
        initial: "",
        type: "editableSelect",
        options: PATIENT_DATA_OPTIONS.axillaryL_v,
    },
    ...
    breathShortness: {
        ...
        initial: "",
        type: "editableSelect",
        options: PATIENT_DATA_OPTIONS.breathShortness,
    },
    percussionally: {
        min: 2,
        max: 100,
    ...
    dullness: {
        ...
        initial: "",
        type: "editableSelect",
        options: PATIENT_DATA_OPTIONS.dullness,
    },
    wheezing: {
        min: 2,
        max: 100,
        ...
        initial: "",
        type: "editableSelect",
        options: PATIENT_DATA_OPTIONS.wheezing,
    },
    ...
    complaints: {
        ...
        initial: "",
        type: "editableSelect",
        options: PATIENT_DATA_OPTIONS.complaints,
    },
};
